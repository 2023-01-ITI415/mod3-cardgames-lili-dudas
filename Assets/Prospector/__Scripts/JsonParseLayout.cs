...
///Implements Unity's ISerializationCallbackReciever Interface.
/// </summary>
[System.Serializable]
public class JsonLayoutSlot : ISerializationCallbackReceiver
{
    ...
    ///<summary>
    ///Required by ISerializationCallbackreciever, but empty in this class
    /// </class>
    public void OnBeforeSerialize() {} //Note the empty braces
}
...
public class JsonLayoutPile {
    public int x, y;
    public string layer;
    public float xStragger; //xStagger fans cards to the side for the draw file
}
