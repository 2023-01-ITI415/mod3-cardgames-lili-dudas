...
public class Deck : MonoBehaviour
{
    ...
    ///all 52 card GameObjects from the jsonDeck and the cardSprites information.
    ///</summary>
    public void InitDeck() {
        //create a static refrence to spritePrefab for the Card class to use
        SPRITE_PREFAB = prefabSprite;
        //call Init method on the CardSpriteSo instance assigned to cardSprites
        cardSprites.Init();

        //get a refrence to the JsonParseDeck component
    ...
    static public void Shuffle(ref List<Card> refCards) {
        ...
        while (refCards.Count > 0) {
            ...
            //Add remove that card from the original List
