...
public class CardSpritesSO : ScriptableObject {
    ...
    ///<summary>
    /// Initiatizes the static elements of CardSpriteSO.
    /// </summary>
    /// <paraam name ="cSSO">CardSpriteSO to be assigned to the Singleton S</param>
    ...
    ///<summary>
    /// Thus public static property makes S.cardBack accessible to other classes
    /// </summary>
